...
export default function PortfolioSkills() {
  return (
    <div id="skills" className="section-container relative overflow-clip z-0">
      <div className="absolute left-0 right-0 top-0 h-[15vh] bg-gradient-to-b dark:from-black from-background to-transparent" />
      <div className="absolute left-0 right-0 bottom-0 h-[15vh] bg-gradient-to-b from-transparent dark:to-background to-background" />
      <div className="-z-10">

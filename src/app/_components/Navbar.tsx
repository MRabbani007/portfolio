  ...
  return (
    <nav
      className={
        ...
        " top-0 left-0 right-0 z-50 text-xl duration-200"
      }
    >
      <div className="flex items-center justify-between p-4 sm:py-8 sm:px-10 mx-auto h-full">
        {/* Logo */}
...
}
{
  /* <ul
            ...
            className={
              ...
              " absolute top-14 -right-4 hidden md:flex items-center gap-5 rounded-lg py-2 px-4 duration-200"
            }
          >
            <li>

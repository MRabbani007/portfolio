...
export default function OnlineStore() {
  const project = projects.find((item) => item.name === "OnlineStore") || {
    images: [],
    imageNames: [],
    live_URL: "/",
  };
    ...
    <div>
      <div className="bg-zinc-900 w-full h-[40vh] relative">
        <div className="text-zinc-50 absolute left-0 bottom-0 p-4">
          <p className="text-2xl">Online Store</p>
          <p>React, Tailwind, Render</p>
        </div>
      </div>
      <div className="p-4 md:max-w-[1000px] mx-auto flex flex-col gap-4">
